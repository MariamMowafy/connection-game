...
function LoginPage() {
  ...
  useEffect(() => {
    const sortedData = Object.entries(leaderboardData).sort(([,a], [,b]) => a.score - b.score).slice(0, 5);
  ...
  return (
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', overflow: 'hidden', fontFamily: 'Segoe UI' }}>
...
<img src={index === 0 ? first : index === 1 ? second : index === 2 ? third : transparent} alt="description of image" style={{ position: 'absolute', left: -20, top: '-18%', width: '27px', height: '65px' }} />
